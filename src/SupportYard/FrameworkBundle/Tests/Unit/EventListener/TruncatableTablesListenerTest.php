...
namespace SupportYard\FrameworkBundle\Tests\Unit\EventListener;

use SupportYard\FrameworkBundle\EventListener\TruncatableTablesListener;
use SupportYard\FrameworkBundle\Tests\Fixtures\TruncatableTableEntity;
