...
namespace SupportYard\FrameworkBundle\Tests\Unit\Request;

use SupportYard\FrameworkBundle\Tests\Fixtures\InvalidAppRequest;
use SupportYard\FrameworkBundle\Tests\Fixtures\ValidAppRequest;
...
class AppRequestTest extends TestCase
{
     ...
     * @expectedExceptionMessage Property SupportYard\FrameworkBundle\Tests\Fixtures\InvalidAppRequest::foo doesn't exist.
     */
    ...
    private function createValidatorAdapter()
    {
        return $this->createMockFor(
            'SupportYard\FrameworkBundle\Validator\ValidatorAdapter'
        );
    }
}
